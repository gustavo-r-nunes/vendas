package io.github.gustavornunes.domain.repositorio;
...
public class ClienteRepository {
    ...
    public void deletar(Cliente cliente){
        deletarById(cliente.getId());
    }

    public List<Cliente> buscarPorNome(String nome){
        return jdbcTemplate.query(SELECT_ALL.concat("where nome like ? "), new Object[]{"%" + nome + "%"}, getRowMapper());
    }
